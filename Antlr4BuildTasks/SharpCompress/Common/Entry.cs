...
namespace SharpCompress.Common
{
    public abstract class Entry : IEntry
    {
        ...
        /// </summary>
        public abstract Nullable<DateTime> LastModifiedTime { get; }

        /// <summary>
        /// The entry create time in the archive, if recorded
        /// </summary>
        public abstract Nullable<DateTime> CreatedTime { get; }

        /// <summary>
        /// The entry last accessed time in the archive, if recorded
        /// </summary>
        public abstract Nullable<DateTime> LastAccessedTime { get; }

        /// <summary>
        /// The entry time when archived, if recorded
        /// </summary>
        public abstract Nullable<DateTime> ArchivedTime { get; }
        ...
        /// </summary>
        public abstract Nullable<long> Attrib { get; }
    }
}
