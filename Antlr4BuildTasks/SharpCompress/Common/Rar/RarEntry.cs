...
namespace SharpCompress.Common.Rar
{
    public abstract class RarEntry : Entry
    {
        ...
        /// </summary>
        public override Nullable<DateTime> LastModifiedTime => FileHeader.FileLastModifiedTime;

        /// <summary>
        /// The entry create time in the archive, if recorded
        /// </summary>
        public override Nullable<DateTime> CreatedTime => FileHeader.FileCreatedTime;

        /// <summary>
        /// The entry last accessed time in the archive, if recorded
        /// </summary>
        public override Nullable<DateTime> LastAccessedTime => FileHeader.FileLastAccessedTime;

        /// <summary>
        /// The entry time whend archived, if recorded
        /// </summary>
        public override Nullable<DateTime> ArchivedTime => FileHeader.FileArchivedTime;
