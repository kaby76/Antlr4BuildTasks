...
namespace SharpCompress.Common.Rar.Headers
{
    ...
    {
        internal static readonly NewSubHeaderType SUBHEAD_TYPE_CMT = new NewSubHeaderType(new byte[] { (byte)'C', (byte) 'M', (byte)'T' });
        // internal static readonly NewSubHeaderType SUBHEAD_TYPE_CMT = new(new byte[] { 'C', 'M', 'T' }};
        ...
        internal static readonly NewSubHeaderType SUBHEAD_TYPE_RR = new NewSubHeaderType(new byte[] { (byte)'R', (byte)'R' });
        ...
        private NewSubHeaderType(params byte[] chars)
        {
