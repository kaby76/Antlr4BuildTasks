...
namespace SharpCompress.Common.Rar.Headers
{
    internal class FileHeader : RarHeader
    {
        ...
        private static Nullable<DateTime> ProcessExtendedTimeV4(ushort extendedFlags, Nullable<DateTime> time, MarkingBinaryReader reader, int i)
        {
        ...
        internal Nullable<DateTime> FileLastModifiedTime { get; private set; }

        internal Nullable<DateTime> FileCreatedTime { get; private set; }

        internal Nullable<DateTime> FileLastAccessedTime { get; private set; }

        internal Nullable<DateTime> FileArchivedTime { get; private set; }
    }
}