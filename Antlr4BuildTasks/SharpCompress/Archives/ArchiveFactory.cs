...
namespace SharpCompress.Archives
{
    public static class ArchiveFactory
    {
        ...
        public static IWritableArchive Create(ArchiveType type)
        {
            switch (type)
            {
                case ArchiveType.Zip: return ZipArchive.Create();
                case ArchiveType.Tar: return TarArchive.Create();
                case ArchiveType.GZip: return GZipArchive.Create();
                default: throw new NotSupportedException("Cannot create Archives of type: " + type);
            }
        }
        ...
        public static IArchive Open(FileInfo fileInfo, ReaderOptions options = null)
        {
            ...
            if (options == null) options = new ReaderOptions { LeaveStreamOpen = false };
        ...
        public static IArchive Open(IEnumerable<Stream> streams, ReaderOptions options = null)
        {
            ...
            if (options == null) options = new ReaderOptions();
