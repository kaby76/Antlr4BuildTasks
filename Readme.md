...
* Set the environment variable "JAVA_EXEC" to the full path of the java executable. See [this](https://confluence.atlassian.com/doc/setting-the-java_home-variable-in-windows-8895.html) for some instructions on how to do this
on Windows.
