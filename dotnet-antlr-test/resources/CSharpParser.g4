...
unary_expression
	...
	| unary_expression IS type_
	| unary_expression AS type_
	| unary_expression IS NULL
	;
...
parenthesized_variable_designation
  : OPEN_PARENS (variable_designation (COMMA variable_designation)*)? CLOSE_PARENS
  ;
...
recursive_pattern
  : type_? positional_pattern_clause? property_pattern_clause? variable_designation?
  ;

positional_pattern_clause
  : OPEN_PARENS (subpattern (COMMA subpattern)*)? CLOSE_PARENS
  ;
