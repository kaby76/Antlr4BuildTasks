...
int AntlrTemplate::Output::changed = 0;
bool AntlrTemplate::Output::first_time = true;

std::string AntlrTemplate::Output::OutputTokens(antlr4::CommonTokenStream& stream)
{
    std::string sb;
...
std::string AntlrTemplate::Output::OutputTree(antlr4::tree::ParseTree& tree, antlr4::CommonTokenStream& stream)
{
    std::string sb;
...
void AntlrTemplate::Output::ParenthesizedAST(antlr4::tree::ParseTree& tree, std::string& sb, antlr4::CommonTokenStream& stream, int level)
{
...
void AntlrTemplate::Output::StartLine(std::string& sb, antlr4::tree::ParseTree& tree, antlr4::CommonTokenStream& stream, int level)
{
    if (changed - level >= 0)
    {
        if (!first_time)
...
bool AntlrTemplate::Output::replace(std::string& str, const std::string& from, const std::string& to) {
...
std::string AntlrTemplate::Output::ToLiteral(std::string& input)
{
...
std::string AntlrTemplate::Output::PerformEscapes(std::string s)
{
    std::string new_s;
